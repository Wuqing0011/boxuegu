...
require(['/bxgmy/assets/js/config.js'],function(){
  require(['jquery', 'template','webuploader', 'validate', 'form','datepicker','uploadify', '/bxgmy/assets/js/common.js'], function ($, template,WebUploader) {
    showInfos()
    ...
    // 完成上传头像功能  //uploadify插件
    //function uploadAvatar () {
    //  var options = {
    //    width: 120,
    //    height: 120,
    //    buttonText: '',
    //    swf: '/bxgmy/assets/libs/uploadify/uploadify.swf',
   ...
   ////原生js
    ...
    function nativaUploader () {
      ...
      xhr.send(fd) // 这里直接传递的是 FormDate的实例对象
